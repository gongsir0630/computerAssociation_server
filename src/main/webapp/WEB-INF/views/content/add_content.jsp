	...
	<body>
		<div class="layui-container layui-card">
			...
			<div class="layui-fluid layui-card-body">
				<form class="layui-form" action="${path}/admin/content/add" method="post">
					...
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-block">
								...
								<div style="color: #0000FF">请输入图片管理界面中已存在的ID信息</div>
							</div>
						</div>
					</div>
					<div class="layui-form-item">
						<div class="layui-inline">
							<label class="layui-form-label">lable内容</label>
							<div class="layui-input-block">
								<input type="text" name="conLabe" id="conLabe" placeholder="请输入" required autocomplete="off" class="layui-input">
							</div>
						</div>
					</div>
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-block">
								<textarea cols="25" rows="50" name="conP" id="conP" placeholder="请输入" required autocomplete="off" class="layui-input"></textarea>
							</div>
						</div>
					</div>
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-block">
								<input type="text" name="detailAddr" id="detailAddr" placeholder="请输入" required autocomplete="off" class="layui-input">
					...
					<div class="layui-form-item layui-col-md-offset1">
						<div class="layui-input-inline">
							<input type="submit" id="btn_addCon" class="layui-btn layui-btn-fluid" value="提交">
						</div>
					</div>
					<div class="layui-form-item layui-col-md-offset1">
						<div class="layui-input-inline">
