	...
	<body>
		<div class="layui-container layui-card">
			...
			<div class="layui-fluid layui-card-body">
				<form class="layui-form" action="${path}/admin/edit?count=${adm.count}" method="post">
					<div class="layui-form-item">
						<div class="layui-inline">
							<label class="layui-form-label">账号</label>
							<div class="layui-input-block">
								<input type="text" name="count" id="count" placeholder="请输入账号" required autocomplete="off" class="layui-input" value="${adm.count}" disabled>
							</div>
						</div>
					</div>
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-block">
								<input type="text" name="password" id="password" placeholder="请输入密码" required autocomplete="off" class="layui-input" value="${adm.password}">
							</div>
						</div>
					</div>
